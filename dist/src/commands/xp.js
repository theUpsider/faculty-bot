    ...
    execute: function (message, args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dbxp = new keyv_1.default("sqlite://xp.sqlite");
                    ...
                    case 2:
                        _a.sent(); // set to 1 for 1 XP
                        message.reply("you can now start to earn xp!");
                        return [2 /*return*/];
                    case 3:
                        message.reply("you have " + Math.trunc(userXP) + " XP. This equals to " + extensions_1.toLevel(Math.trunc(userXP)) + " Levels.");
                        _a.label = 4;
