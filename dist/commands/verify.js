                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!!memberToAdd.roles.cache.has(memberToAdd.guild.roles.cache.find(function (role) { return role.name === general_settings_json_1.default.roles.verified; }).id)) return [3 /*break*/, 3];
                        ...
                        case 3:
                            try {
                                ...
                                memberToAdd.guild.roles.cache.find(function (role) { return role.name === general_settings_json_1.default.roles.verified; }).id);
                            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    ...
                    else if (memberToAdd.roles.cache.has(memberToAdd.guild.roles.cache.find(function (role) { return role.name === general_settings_json_1.default.roles.verified; }).id)) {
                ...
                case 10:
                    extensions_1.logMessage(message, message.author.username + " send an email from a non-student adress. Maybe dig into this @" + general_settings_json_1.default.roles.staffrole + ".");
